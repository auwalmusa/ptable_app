...
# Add rectangles for each element
p.rect("group_str", "period_str", width=0.95, height=0.95, source=source, fill_color=factor_cmap('group_str', palette=colors, factors=df['group_str'].unique()), line_color=None)
